 ...
 */
public class RecentOverallStudentStatusFragment extends Fragment {

    @BindView(R.id.recentOverallStudentStatusLineChart)
    LineChart lineChart;

    private LineData lineData;

    public static RecentOverallStudentStatusFragment newInstance() {
        Bundle args = new Bundle();

        RecentOverallStudentStatusFragment fragment = new RecentOverallStudentStatusFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_recent_overall_student_status, container, false);
